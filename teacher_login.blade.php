...
<body oncontextmenu="return false">
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('{{ asset('img/inspire.jpg') }}');">
...
@endif        
                <form autocomplete="off" method="POST" action="{{ route('teacher-login') }}" class="login100-form validate-form p-b-33 p-t-5">
                        @csrf
